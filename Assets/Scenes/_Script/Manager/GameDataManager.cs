...
namespace UIGameDataManager
{
    ...
    public class GameDataManager : MonoBehaviour
    {
        ...
        void AddItem()
        {
            ...
            m_GameData.enemyStoneUpStar += ItemADD;
            m_GameData.gold += 500;
        ...
        void UpdateGems()
        {
            ...
            Debug.Log("GameData: " + m_GameData.enemyStoneUpStar);
        }
        void UpdatePotions()
        {
            if (m_GameData != null)
        ...
        public bool CanStarUp(CharacterData character)
        {
            ...
            return (character.GetXPForNextStar() <= m_GameData.enemyStoneUpStar);
        }
        ...
        void PayStarUpGems(uint numberGems)
        {
            if (m_GameData != null)
            {
                m_GameData.enemyStoneUpStar -= numberGems;
                GemsUpdated?.Invoke(m_GameData);
            }
        }
